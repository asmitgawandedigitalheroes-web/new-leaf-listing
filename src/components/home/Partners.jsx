...
const PARTNERS = [
  {
    id:   'nuevo-vizion',
    name: 'Nuevo Vizion',
    sub:  'Ingenieria Y Architectura',
    logo: '/partners/nuevo-vizion.svg',
    desc: 'Premier engineering & architecture firm specializing in residential and commercial development across North America and Mexico.',
    href: '#',
    accent: '#6BBF3E',
  },
  {
    ...
    desc: 'Trusted real estate network connecting buyers and sellers with top-performing agents and exclusive off-market opportunities.',
    href: '#',
    accent: '#6BBF3E',
  },
  {
    id:   'bold-group-dev',
    name: 'Bold Group Dev',
    sub:  'Development Group',
    logo: '/partners/bold-group-dev.svg',
    desc: 'Elite development group driving high-value projects and investment opportunities across emerging and established markets.',
    href: '#',
    accent: GOLD,
  },
];
